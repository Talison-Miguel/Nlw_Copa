...
import usersAvatar from '../assets/users-avatar-exemple.png'
...
export default function Home(props: HomeProps) { 
    ...
    async function createPool(event: FormEvent) {
        ...
        try {
            ...
            alert('Bolão criado com sucesso, codigo foi copiado para a área de transferência.')
    ...
    return (
    <div className='max-w-[1124px] mx-auto h-screen grid grid-cols-2 items-center gap-28 my-20'>
        <main>
        ...
        <Image src={appPreviewImg} alt="Dois celulares exibindo um preview da aplicaçao movel da Nlw-Copa" quality={100}/>
    </div>
    )
    }
